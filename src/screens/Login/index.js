...
import { actSetIsOpenSideBar, actSetLogin } from "../../redux/actions/browser.action";
...
const LoginPage = () => {
    ...
    const onSubmit = async (data) => {
        try{
            ...
            localStorage.setItem('token-yb', loginResult.data.data.token);
    ...
    return(
        <div className="login row">
            <div className="left-page col-7">
                ...
                <img src={`${process.env.REACT_APP_URL_BE}/images/image/image_default.png`} alt="login" width={550} height={500}></img>
            </div>
